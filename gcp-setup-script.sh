...
if [ $KEY_CREATE_EXIT -ne 0 ]; then
  if echo "$KEY_CREATE_OUTPUT" | grep -q "disableServiceAccountKeyCreation"; then
    ...
    echo ""
    echo "Your GCP org has 'iam.disableServiceAccountKeyCreation' enabled."
    echo "An org admin must add an exception. Steps below."
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo "HOW TO FIX: Add an exception (Org Admin only)"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "1. Open: https://console.cloud.google.com/iam-admin/orgpolicies/iam-disableServiceAccountKeyCreation"
    echo "   (Or: IAM & Admin → Organization policies → search 'iam.disableServiceAccountKeyCreation')"
    echo ""
    echo "2. Click 'Manage policy'"
    echo ""
    echo "3. Under 'Policy rules', click 'Add rule'"
    echo ""
    echo "4. Set 'Enforcement' to 'Override'"
    echo ""
    echo "5. Under 'Customize', add an exception:"
    echo "   • Option A (project): Add 'projects/$PROJECT_ID' to the exception list"
    echo "   • Option B (service account): Add 'serviceAccount:$SERVICE_ACCOUNT_EMAIL'"
    echo ""
    echo "6. Click 'Save' and wait a few minutes for the policy to propagate."
    echo ""
    ...
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "Alternative: Use a different GCP project that does not have this constraint."
    exit 1
  fi
fi
