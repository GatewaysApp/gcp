...
echo ""
echo "Troubleshooting: If scalable server deletion fails with 403 (e.g. compute.globalForwardingRules.delete,"
echo "compute.instanceGroupManagers.update), ensure this script was run for the SAME project where resources"
echo "are created. Check gcloud config: gcloud config get-value project"
echo ""
